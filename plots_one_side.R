...
#setwd("C:/foo")
plots_one_side = function(x, compVal, ropeRad, plotname, HDImass = .95){
source("./openGraphSaveGraph.R")
source("./plotPost_one_side.R")
source("./HDIofMCMC.R") 

paramMCMCsample = x
# Plot the posterior with HDI and ROPE:
postInfo = plotPost_one_side( paramMCMCsample , compVal=compVal ,
                     ROPE=compVal+c(-ropeRad, 100) , showMode=TRUE ,
