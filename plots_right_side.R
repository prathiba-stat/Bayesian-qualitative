#set working directory and remove the hashtag sign from line 2
#setwd("C:/foo")
plots_right_side = function(x, compVal, ropeRad, plotname, HDImass = .95){
source("./openGraphSaveGraph.R")
source("./plotPost_right_side.R")
source("./HDIofMCMC.R") 

paramMCMCsample = x
# Plot the posterior with HDI and ROPE:
postInfo = plotPost_right_side( paramMCMCsample , compVal=compVal ,
                     ROPE=compVal+c(-ropeRad, 120) , showMode=TRUE ,
